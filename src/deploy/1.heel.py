...
sudo date -s "20 Apr 2024 13:00:00"

pin_to_circuit = 24
interrupt_pin = 15

UDP_IP_r = "192.168.0.101"
UDP_PORT_r = 6006
UDP_IP_t = "192.168.0.104"
UDP_PORT_t = 6001
Message = b'1.heel'
...
def isoImaging(camera):
    ...
    camera.capture("/home/pi1/Desktop/Images/"+ time_capture + "-" + string +".jpg",
                   use_video_port=True, 
                   quality=90)
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            print('        wait for UDP interrupt, 1 -> 4 left step time')
